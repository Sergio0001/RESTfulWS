			...
			<table class="table table-striped">
				...
				<%--
					6(b)Se obtiene cada uno de los atributos
					 ...
					 archivo
				 --%>
				<c:forEach var="i" begin="0" end="${fn:length(requestScope.paths)}">
					<tr>
						<td><a href="Download.do?archivo=${requestScope.paths.get(i)}"><%--nombre de archivo --%></a></td>
						<td><%--path --%>${requestScope.paths.get(i)}</td>
						<td><%--tamaño --%>${requestScope.paths.get(i)}</td>
